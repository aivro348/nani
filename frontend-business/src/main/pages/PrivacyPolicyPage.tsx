...
export function PrivacyPolicyPage() {
  useSEO(
    'Privacy Policy | Scaro Technologie',
    'Read our Privacy Policy to understand how Scaro Technologie collects, uses, and protects your personal data and information across our platform.'
  );
    ...
    <div className="min-h-screen bg-page-bg text-page-fg">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <p>
            At <strong>Scaro Technologie</strong>, we collect information to provide better services to our students, educators, and enterprise partners. The types of personal information we collect include:
          </p>
