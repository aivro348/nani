    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          >
            Scaro Technologie is a Bengaluru & Chennai based AI-powered website design, e-commerce, mobile app and automation company helping businesses grow online since 2026.
          </motion.p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-slate-600">
              <p>
                Established in 2026, Scaro Technologie has evolved into a modern AI-powered digital solutions agency specializing in websites, e-commerce, mobile apps, AI chatbots, AI agents and business automation.
              </p>
              <p>
