...
export function BusinessPage() {
  ...
  useSEO(
    'Scaro Technologie | Enterprise AI & Software Solutions',
    'Official corporate services by Scaro Technologie: Enterprise AI Solutions, Web & Mobile App Development, and Data Analytics.',
    businessSitelinks
  );
