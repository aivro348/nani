...
export function AboutUsPage() {
  useSEO(
    ...
    'Learn more about Scaro Technologie, our mission, vision, and the core values that drive our commitment to bridging the gap between education and industry.'
  );
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--primary-gold)]/20 text-[var(--primary-gold)] text-sm font-bold tracking-wide uppercase mb-6">
              <Building2 className="w-4 h-4" /> About Scaro Technologie
            </div>
