...
export function CertificateVerificationPage() {
  useSEO(
    'Verify Certificate | Scaro Technologie',
    'Verify the authenticity of Scaro Technologie certifications, internships, and program completion certificates.'
  );
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-10 text-center relative overflow-hidden">
            ...
            <p className="text-blue-100 text-lg max-w-md mx-auto">
              Enter your unique certificate ID or scan the QR code to verify your Scaro Technologie credential.
            </p>
          </div>
                    ...
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-page-fg">
                          This is a valid certificate issued by Scaro Technologie.
                        </p>
                      </div>
                    </div>
