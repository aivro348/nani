...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, all Scaro Technologie certifications are highly regarded by industry leaders. Our curriculum is co-developed with corporate tech partners, ensuring that the skills you learn are exactly what hiring managers are looking for today."
  },
  {
