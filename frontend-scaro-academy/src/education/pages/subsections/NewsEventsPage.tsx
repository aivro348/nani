...
export function NewsEventsPage() {
  useSEO('News & Events | Scaro Academy', 'Stay updated with the latest happenings at Scaro Technologie.');
    ...
    <div className="min-h-screen bg-slate-50 pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          {[
            { date: 'Oct 15, 2026', title: 'Scaro Technologie partners with leading AI Firm', desc: 'A new joint certification program in Advanced Machine Learning.' },
