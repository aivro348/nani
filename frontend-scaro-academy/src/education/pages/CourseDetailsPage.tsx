        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-2xl space-y-6">
              ...
              <motion.button aria-label="Action button"
                onClick={handleEnrollClick}
                animate={{ scale: [1, 1.05, 1], boxShadow: ["0px 4px 10px rgba(0,0,0,0.1)", "0px 10px 25px rgba(255,183,0,0.6)", "0px 4px 10px rgba(0,0,0,0.1)"] }}
                transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
                className="bg-[var(--primary-gold)] hover:bg-[#e63500] text-white font-bold px-8 py-3.5 rounded-xl transition-colors shadow-lg active:scale-95 text-sm uppercase tracking-wider block"
              >
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 hidden lg:block">
             <div className="sticky top-32 bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
                ...
                <motion.button aria-label="Action button" 
                  onClick={handleEnrollClick}
                  animate={{ scale: [1, 1.03, 1], boxShadow: ["0px 4px 10px rgba(0,0,0,0.1)", "0px 10px 20px rgba(255,183,0,0.6)", "0px 4px 10px rgba(0,0,0,0.1)"] }}
                  transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
                  className="w-full bg-[var(--primary-gold)] text-white font-bold text-lg py-4 rounded-xl hover:bg-[#e63500] transition-colors active:scale-95"
                >
