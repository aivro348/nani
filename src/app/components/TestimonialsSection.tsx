  ...
  const testimonials = [
    {
      ...
      branch: 'CS/IT',
      image: '👩‍💻',
      content: 'Scaro Technologies transformed my career! The structured roadmap and live projects helped me land my dream job at Google. The mentorship was invaluable.',
      rating: 5,
    },
    {
      name: 'Rahul Verma',
