      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <div className="space-y-2 text-sm text-text-muted">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:support@scaro.com" className="hover:text-heading transition-colors">
                  support@scaro.com
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-blue-400" />
                <a href="mailto:info@scaro.com" className="hover:text-heading transition-colors">
                  info@scaro.com
                </a>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="border-t border-surface-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-text-muted text-center md:text-left">
            © 2025 Scaro Technologies. All rights reserved.
          </p>
