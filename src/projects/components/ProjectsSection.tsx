          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-text-muted max-w-lg leading-relaxed text-sm">
                Built something amazing? Share your project with the Scaro Technologies community!
            ...
            <div className="flex flex-col gap-3 shrink-0">
              <motion.a href="https://github.com/Scaro Technologies" target="_blank" rel="noopener noreferrer"
