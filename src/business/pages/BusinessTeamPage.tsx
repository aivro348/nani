...
export function BusinessTeamPage() {
  useSEO(
    'Our Executive Team | Scaro Technologies',
    'Meet the engineering experts, AI researchers, and digital product architects at Scaro Technologies driving enterprise transformations.'
  );
