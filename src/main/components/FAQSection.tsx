...
const faqs = [
  ...
  },
  {
    ...
    answer: "Scaro Technologies offers a mix of free and premium content. All basic learning roadmaps and career guidance articles are free to access. Advanced specialized courses, premium project mentors, and personalized placement support are part of our premium membership plans."
  },
  {
  ...
  {
    question: "Can Scaro Technologies help me with campus placements?",
  ...
  },
  {
    ...
    answer: "Yes, upon successful completion of a roadmap and its associated capstone project, students receive a verified Scaro Technologies Industry Certification that can be shared on LinkedIn and added to resumes."
  }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-text-muted max-w-2xl mx-auto">
            Everything you need to know about Scaro Technologies and how to jumpstart your engineering career.
          </p>
        </motion.div>
