  ...
  const stories = [
    {
      ...
      testimonial: 'Scaro Technologies transformed my career. The personalized AI roadmap and real projects gave me the confidence to crack Amazon interviews. Within 3 months, I went from zero to hero!',
      timeline: '12 weeks',
    ...
    },
    {
      ...
      testimonial: 'After 6 months of failed interviews, Scaro Technologies gave me the robotics and AI skills that made me stand out. The project portfolio opened doors to global companies!',
      timeline: '16 weeks',
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-text-muted max-w-2xl mx-auto">
            See how Scaro Technologies students landed dream jobs at top companies
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600/20 to-cyan-500/20 border border-blue-500/30 rounded-full">
                    ...
                    <span className="text-cyan-400">with Scaro Technologies</span>
                  </div>
                </motion.div>
