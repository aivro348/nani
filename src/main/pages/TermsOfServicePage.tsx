...
export function TermsOfServicePage() {
  useSEO(
    'Terms of Service | Scaro Technologies',
    'Read the Terms of Service for using Scaro Technologies platform, including guidelines for students, enterprise partners, and content usage.'
  );
    ...
    <div className="min-h-screen bg-page-bg text-page-fg">
      ...
      <section className="relative w-full pt-32 pb-16 px-4 bg-gradient-to-b from-[var(--primary-gold)]/5 to-transparent overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            These Terms of Service govern your use of the Scaro Technologies platforms, websites, and associated services.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <p>
            By accessing and using the <strong>Scaro Technologies</strong> website, educational platform, or enterprise services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must not use our services.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <li>Scaro Technologies reserves the right to suspend or terminate accounts that violate these terms or exhibit suspicious behavior.</li>
          </ul>

          <h2 className="mt-12">3. Educational Content and Intellectual Property</h2>
          <p>
            All content provided on the Scaro Academy platform, including but not limited to roadmaps, course materials, videos, text, graphics, and AI tools, is the intellectual property of Scaro Technologies or its licensors.
          </p>
          <p>
