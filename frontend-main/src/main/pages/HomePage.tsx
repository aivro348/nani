...
export function HomePage({ setActiveSection }: { setActiveSection?: (section: string) => void }) {
  ...
  useSEO(
    'Scaro Technologie | Unified Technology & Education Ecosystem',
    'Scaro Technologie connects enterprise IT solutions, elite skill-based education, and cutting-edge AI tools into one unified platform.',
    educationSitelinks
  );
      ...
      <section className="relative min-h-screen flex items-center bg-[#111] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20">
          <div className="max-w-3xl space-y-8">
            ...
            >
              Scaro Technologie operates a continuous innovation loop that links our enterprise solutions agency, hands-on student cohorts, and advanced AI platforms.
            </motion.p>
            ...
            >
              <button aria-label="Action button" onClick={() => window.location.href = 'http://localhost:5173/'} className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B89628] hover:from-white hover:to-white text-black font-black text-sm transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                Explore Academy Paths
                <ArrowRight className="w-4 h-4" />
              </button>
              <button aria-label="Action button" onClick={() => window.location.href = 'http://localhost:5175/'} className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white font-bold text-sm transition-all flex items-center justify-center gap-2">
            ...
            >
              ...
              <div className="p-5 bg-[#FAF8F5] border border-[rgba(92,20,29,0.06)] rounded-xl relative">
                ...
                <p className="text-xs text-slate-500 italic mb-4 leading-relaxed">
                  "Scaro Technologie transformed my career! The structured roadmap and live projects helped me land my dream job at Google. The mentorship was invaluable."
                </p>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <button aria-label="Action button" 
                  onClick={() => window.location.href = 'http://localhost:5174/all-ai-tools'}
