...
export function Navbar() {
  ...
  let navItems: Array<{ id: string; label: string; path?: string; subItems?: Array<{ label: string; path: string }> }> = [
    { id: 'courses', label: 'Scaro Academy', path: 'http://localhost:5173/' },
    { id: 'ai', label: 'AI Academy', path: 'http://localhost:5174/' },
    { id: 'business', label: 'Business', path: 'http://localhost:5175/' },
];
